...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _TheHeader_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TheHeader.vue */ "./resources/js/components/TheHeader.vue");
//
//
//
//
...
var render = function() {
  ...
  return _c(
    "div",
    [_c("the-header"), _vm._v(" "), _vm._m(0), _vm._v(" "), _vm._m(1)],
    1
  )
}
var staticRenderFns = [
  function() {
    ...
    return _c("section", { staticClass: "hero" }, [
      _c("div", {
        ...
        staticStyle: { "background-image": "url(img/hero.jpg)" }
      }),
      _vm._v(" "),
      _c("h1", [_vm._v("認印画像作成ツール")]),
      _vm._v(" "),
      _c("div", [
        _c("input", {
          staticClass: "new",
          attrs: { type: "text", placeholder: "田中" }
        }),
        _vm._v(" "),
        _c(
          "a",
          {
            staticClass: "btn",
            attrs: { href: "#", id: "newBtn", onclick: "buttonClick()" }
          },
          [_vm._v("つくる")]
        )
      ])
